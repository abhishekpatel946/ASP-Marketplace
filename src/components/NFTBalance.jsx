...
function NFTBalance({ inputValue, setInputValue }) {
  ...
  const [buyVisible, setBuyVisiblity] = useState(false);
    ...
    <div style={{ padding: "15px", maxWidth: "1030px", width: "100%" }}>
          ...
          NFTCollections.map((nft, index) => {
            ...
            return (
              <Card
                ...
                actions={[
                  <Tooltip title={`Explore ${nft.name}`}>
                    <RightCircleOutlined
                ...
                key={index}
              >
                <Meta title={nft.name} description={nft.addrs} />
              </Card>
            );
          })}
      </div>
      ...
      {buyVisible && (
        <Modal
          ...
          visible={buyVisible}
          onCancel={() => setBuyVisiblity(false)}
