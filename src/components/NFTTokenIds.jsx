...
import ContractABI from "../contracts/contractInfo.json";
...
function NFTTokenIds() {
  ...
  const [sellVisible, setSellVisiblity] = useState(false);
  ...
  const queryMarketItems = useMoralisQuery("PolygonTransactions");
  ...
  const sell = async (nft, amount) => {
    const price = amount * ("1e" + 18);
    const options = {
      contractAddress: "0xf2910b4f99736f8c0f0ef759dcf9858e81330201",
    ...
    <div style={{ padding: "15px", maxWidth: "1030px", width: "100%" }}>
      ...
      {transferVisible && (
        <Modal
          ...
          onCancel={() => setTransferVisibility(false)}
      ...
      {sellVisible && (
        <Modal
          ...
          visible={sellVisible}
          onCancel={() => setSellVisiblity(false)}
          onOk={() => sell(nftToSell, amountToSell)}
          confirmLoading={isPending}
          okText="Sell"
        >
          <img
